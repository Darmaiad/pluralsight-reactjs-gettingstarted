...
It includes an implementation of timer challenge issued by the course's author at the end of the project. I expanded on that bu having the game including a distinct start/stop phase. Finally, I used [Alertify.js](http://alertifyjs.com/) to display a couple of messages.
