...
It includes an implementation of timer challenge issued by the course's author at the end of the project. I expanded on that bu having the game including a distinct start/stop phase.

TODO:
* Style the project some more with bootstrap and fa
* Implement some alert messages, using alertify.js
